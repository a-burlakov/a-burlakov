...
def generate_readme():
    ...
    for post in recent_posts:
        md_link_line = f"* [{post['title']}]({url_origin + post['get_absolute_url']})"
        recent_posts_md_texts.append(md_link_line)
    ...
    with open("README.md", "w") as readme:
        readme_md_text = md_template.format(
            RECENT_POSTS=recent_posts_text, URL_ORIGIN=url_origin
        )
